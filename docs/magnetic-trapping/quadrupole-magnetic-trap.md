...
Conceptually, the XFER coil acts like a giant shim coil that shifts the field minimum of the QMT along the $y$ direction. The current is simply ramped slowly (and flipped midway) to adiabatically move the field minimum from the MOT location to the chip location.

A strange complication is that there is only one XFER coil. There used to be two, but the one closest to the table was magnetizing it and causing problems. The math for one coil is not as nice and not really detailed in any thesis I could find. If you have time, please fill in some of these details.
