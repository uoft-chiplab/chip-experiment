...
If after a few seconds the website has not changed upon refresh, then the build might have failed. See https://github.com/uoft-chiplab/chip-experiment/actions to see the action log.
